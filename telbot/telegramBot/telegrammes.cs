...
namespace telegramBot
{
    class Telegrammes
    {
        ...
        static string chatId = "47130610"; //имя канала//"47130610"; //имя канала
        static string key = "382577814:AAHMmUqL4n0wYdWDPFy9hh5jqfvUNXLKtms"; //имя канала
        static TelegramBotClient bot = new TelegramBotClient("382577814:AAHMmUqL4n0wYdWDPFy9hh5jqfvUNXLKtms");//инициализация;
        ...
        public static async void getCurency()
        {
            ...
            try
            {
                ...
                {
                    if (update.Message != null)//update.ChannelPost != null )//&& update.Message != null) //update.Message.Text != null)//update != null &&
                    {
                        ...
                        {
                            NanopoolPrice m = NanopoolExplorer.ETNNanopoolPrice().Result;
                            SendMes("btc_etn: " + m.data.price_btc + "\r\n" + "btc_etn: " + m.data.price_usd);
                        }

                        if (update.Message.Text.ToString() == "/nanopoolstat")
                        {
                            string s;
                            ...
                            s = "balance: " + m.Data.balance + "\n" + "hashrate: " + m.Data.hashrate+"\n"+"workers: "+"\n";
                            foreach(var v in m.Data.workers)
                            {
                                s += "id: " + v.id + " hash: " + v.hashrate + "\n";
                            }
                            SendMes(s);
                        }
